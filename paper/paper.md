...
![Computational performance of the `dvs_ctree` app on 960 REFSOIL microbial dataset using 8 cores. The wall time taken to run the algorithm grows linearly with respect to the number of sequences.](figs/ctree_times/ss_2500/time_vs_numseqs.png.pdf){#fig:ctree-time}
